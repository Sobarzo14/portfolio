    ...
    <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-sm shadow-sm z-50">
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <a href="#" className="text-2xl font-bold text-amber-600">John</a>
          
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <a href="#projects" className="flex items-center gap-2 text-gray-600 hover:text-amber-600">
              <Coffee size={18} />
              <span>Projects</span>
            </a>
            <a href="#blog" className="flex items-center gap-2 text-gray-600 hover:text-amber-600">
              <Pen size={18} />
              <span>Writing</span>
            </a>
            <a href="#photography" className="flex items-center gap-2 text-gray-600 hover:text-amber-600">
              <Camera size={18} />
              <span>Photos</span>
            </a>
            <a href="#contact" className="px-4 py-2 bg-amber-100 text-amber-700 rounded-lg hover:bg-amber-200">
              Say Hello
            </a>
          </div>
